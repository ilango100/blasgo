...
func CDOTU(N int, X []complex64, incX int, Y []complex64, incY int) (c complex64) {
	C.blasgo_cdotu(C.int(N), unsafe.Pointer(&X[0]), C.int(incX), unsafe.Pointer(&Y[0]), C.int(incY), unsafe.Pointer(&c))
	return c
}

//CDOTC performs dot product of X and congugate Y.
func CDOTC(N int, X []complex64, incX int, Y []complex64, incY int) (c complex64) {
	C.blasgo_cdotc(C.int(N), unsafe.Pointer(&X[0]), C.int(incX), unsafe.Pointer(&Y[0]), C.int(incY), unsafe.Pointer(&c))
	return c
}

//ZDOTU performs dot product of X and Y.
func ZDOTU(N int, X []complex128, incX int, Y []complex128, incY int) (c complex128) {
	C.blasgo_zdotu(C.int(N), unsafe.Pointer(&X[0]), C.int(incX), unsafe.Pointer(&Y[0]), C.int(incY), unsafe.Pointer(&c))
	return c
}

//ZDOTC performs dot product of X and Y.
func ZDOTC(N int, X []complex128, incX int, Y []complex128, incY int) (c complex128) {
	C.blasgo_zdotc(C.int(N), unsafe.Pointer(&X[0]), C.int(incX), unsafe.Pointer(&Y[0]), C.int(incY), unsafe.Pointer(&c))
	return c
}
